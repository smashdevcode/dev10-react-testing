      ...
      return (
        <form onSubmit={handleSubmit}>
          ...
          <fieldset>
            ...
            <input id="section-input" value={section} onChange={(evt) => setSection(evt.target.value)} />
          </fieldset>

          <fieldset>
            <label htmlFor="row-input">Row: </label>
            <input id="row-input" type="number" value={row} onChange={(evt) => setRow(evt.target.value)} />
          </fieldset>

          <fieldset>
            <label htmlFor="column-input">Column: </label>
            <input id="column-input" type="number" value={column} onChange={(evt) => setColumn(evt.target.value)} />
          </fieldset>
          
          <fieldset>
            <label htmlFor="material-input">Material:</label>
            <select id="material-input" value={material} onChange={(evt) => setMaterial(evt.target.value)}>
          ...
          <fieldset>
            ...
            <input id="yearInstalled-input" type="number" value={yearInstalled} onChange={(evt) => setYearInstalled(evt.target.value)}/>
          </fieldset>

          <fieldset>
            <label htmlFor="tracking-input">Is tracking?</label>
            <input id="tracking-input" type="checkbox" checked={tracking} onChange={(evt) => setTracking(evt.target.checked)} />
          </fieldset>
